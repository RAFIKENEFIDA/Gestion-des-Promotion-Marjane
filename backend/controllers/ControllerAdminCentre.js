...
exports.addAdminCentre = async (req, res) => {
    // Save User to Database
     ...
     var idCentre=await ModelCentre.getCentreByVille(req,res,req.body.ville);
     console.log(idCentre);
     data.idcentre=idCentre[0].id;
     var result= await ModelAdminCentre.insertAdminCentre(req,res,data);
     if(result){

...
module.exports={
    ...
    signinAdminGeneral: async function(req,res){
        var sql=`(SELECT * FROM admingeneral WHERE email='${req.body.email}')`;
       var data= await  this.promise(sql);
       return data;
    },
    signinAdminCentre: async function(req,res){
    ...
    signinResponsableRayon: async function(req,res){
